...
@dataclass
class NuminaMathEnvConfig(BaseEnvConfig):
    """Configuration for Numina Math environment"""

    # Dataset config
    dataset_path: str = "/mnt/chensiheng/ai_researcher_data/numinamath_new/train_subset.parquet"
    ...
    limiter_tag: str = "numina_math_env"
