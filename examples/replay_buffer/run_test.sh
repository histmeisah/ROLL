...
echo ""
echo "=== Optimized Training Parameters (8GPU Replay Buffer Testing) ==="
echo "adv_estimator: reinforce (keeping as requested)"
echo "rollout_batch_size: 1024 (all variants now unified)"
echo "val_batch_size: 1024 (all variants now unified)"
echo "sequence_length: 8192 (all variants now unified)"
echo "gradient_accumulation_steps: 256 (all variants now unified)"
...
echo "GPU Configuration: 8x A800-SXM4-40GB"
